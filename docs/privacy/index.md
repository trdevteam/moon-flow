...
MoonFlow is designed with privacy as a top priority. We do not require an account, and we aim to keep your sensitive health data under your control.

---

## 1) What data MoonFlow stores
...
MoonFlow stores your tracking data **locally on your device**.
...
MoonFlow does **not** require account registration.

---

## 5) Ads and tracking

MoonFlow is designed to be **ad-free**.

MoonFlow does not sell your personal data.
...
## 7) Third-party services (analytics / crash reports)

MoonFlow is built to work without sharing your health entries with third parties.
...
Because your data is stored locally on your device, you can remove it by:

- Using any in-app delete/reset options (if available), and/or
- Uninstalling MoonFlow from your device
